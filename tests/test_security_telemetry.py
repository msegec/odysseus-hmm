...
Pins the behavior of the telemetry foundation described in
`docs/security-telemetry-visual-concepts.html` and the Continual Improvement
Loop in `docs/PROJECT_CURRENT_FEATURES_AND_GOALS.md`:
